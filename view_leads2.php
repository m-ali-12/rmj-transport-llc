        ...
        function initializeAssignLeadsModal() {
            ...
            if (assignLeadsBtn) {
                assignLeadsBtn.addEventListener('click', function() {
                    const selectedLeads = Array.from(emailCheckboxes)
                        .filter(checkbox => checkbox.checked)
                        .map(checkbox => {
                    ...
                    if (selectedLeads.length > 0) {
                        // Create form data to send to assign page
                        const form = document.createElement('form');
                        form.method = 'POST';
                        form.action = 'assign_leads.php';

                        selectedLeads.forEach(lead => {
                            const leadInput = document.createElement('input');
                            leadInput.type = 'hidden';
                            leadInput.name = 'selected_leads[]';
                            leadInput.value = JSON.stringify(lead);
                ...
                <div class="filter-group">
                    ...
                    <div class="custom-select-container">
                        ...
                        <div class="custom-options" id="custom-options">
                            ...
                            $all_statuses = ['Booked', 'Not Pick', 'Voice Mail', 'In Future Shipment', 'Qutation', 'Invalid Lead', 'Stop Lead', 'Already Booked', 'Delivered'];
